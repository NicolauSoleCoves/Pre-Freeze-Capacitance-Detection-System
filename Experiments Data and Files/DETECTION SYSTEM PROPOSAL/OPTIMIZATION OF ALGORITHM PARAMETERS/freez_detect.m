function [DTs, Dts, DTps, Dtps, n_detected] = freez_detect(sourceFolder, thup, thdown, WindowSize_C, WindowSize_S, numfigure,PRINT)
...
n_detected = length(xVals);

sgtitle(sprintf('n = %d and threshold = %.4f', n_detected, th2));
